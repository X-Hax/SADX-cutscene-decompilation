...
void ev00D2_b_car(int state)
{
	...
	case 1:
		...
		EV_CameraAng(0, 0, 65305, 49348, 0);
		EV_CameraPos(0, 10, 468.95999f, 15.03f, 885.89001f);
		EV_CameraAng(0, 10, 65305, 49348, 0);
		EV_Wait(15);
		...
		EV_CameraAng(0, 0, 64537, 24772, 0);
		EV_Wait(10);
		EV_CameraPos(0, 30, 449.67999f, 7.1799998f, 908.5f);
		EV_CameraAng(0, 30, 64537, 24772, 0);
		EV_Wait(40);
		...
		EV_CameraAng(0, 0, 64537, 46788, 0);
		EV_SerifPlay(1326);
		...
		EV_CameraAng(0, 100, 58323, 25119, 0);
		EV_Wait(30);
		EV_SerifPlay(1328);
