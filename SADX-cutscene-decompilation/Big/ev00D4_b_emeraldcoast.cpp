...
void ev00D4_b_emeraldcoast(int state)
{
	...
	case 1:
		...
		EV_CreateObject(&Frog,
			...
			(int)player->twp->pos.x - 16384,
			(int)player->twp->pos.y - 16384,
		...
		EV_ClrAction(e102);
		EV_CameraPerspective(1, 60, 12015);
		EV_Wait(1);
		...
		EV_Wait(20);
		EV_CameraTargetFree();
		EV_CameraAng(1, 110, 4352, 8385, 0);
		stopObjectAll();
