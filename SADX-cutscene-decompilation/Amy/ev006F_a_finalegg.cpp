...
void ev006F_a_finalegg(int state)
{
    ...
    case 1:
        ...
        EV_CameraAng(0, 0, 63891, 39526, 0);
        EV_CameraPos(0, 100, 109.31f, -144.0f, 409.82001f);
        EV_CameraAng(0, 100, 63891, 39526, 0);
        EV_Wait(1);
        ...
        EV_CreatePlayer(2, EggrobForEvent0, 170.0f, 60.98f, 550.0f, 0, 22914, 0);
        EV_Wait(1);
        zero = EV_GetPlayer(2);
        ...
        EV_CameraAng(0, 0, 63379, 36710, 0);
        EV_Wait(25);
        ...
        EV_CameraAng(0, 0, 659, 28262, 2560);
        EV_ClrAction(player);
