...
void ev0070_a_returncarrier(int state)
{
	...
	case 1:
		...
		EV_CameraAng(0, 0, 0x700, 0x9E00, 0);
		...
		EV_CameraAng(0, 0, 0xD00, 0x600, 0);
		EV_Wait(10);
		EV_CameraPos(0, 10, 7.0700002f, 4.77f, -159.3f);
		EV_CameraAng(0, 10, 0xD00, 0x600, 0);
		EV_Wait(10);
		EV_SetFace(player, "G");
		EV_SerifPlay(985);
