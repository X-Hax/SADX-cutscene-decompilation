...
void ev0060_a_intro1(int state)
{
	...
	case 1:
		...
		EV_CameraAng(0, 0, 64000, 49408, 0);
		EV_CameraPos(0, 210, 106.7f, 7.5100002f, 792.96503f);
		EV_CameraAng(0, 210, 0, 49408, 0);
		...
		EV_CreateObject(&boy1, 292.70001f, 0.0f, 729.70001f, 0, 15256, 0);
		EV_CreateObject(&girl1, 292.70001f, 0.0f, 729.70001f, 0, 15256, 0);
		EV_Wait(1);
		...
		EV_CameraAng(0, 0, 54784, 39936, 65280);
		EV_CameraPos(0, 125, 120.4f, 12.04f, 731.12598f);
		EV_CameraAng(0, 125, 59136, 39936, 65280);
		EV_Wait(30);
		EV_ClrFace(player);
		...
		EV_CameraAng(0, 0, 3840, 55552, 0);
		EV_CameraAng(0, 60, 3840, 51855, 0);
		EV_SerifPlay(834);
		...
		EV_CameraAng(0, 0, 2560, 5888, 0);
		EV_CameraAng(0, 50, 2560, 9984, 0);
		EV_SerifPlay(835);
		...
		EV_CameraAng(0, 0, 1024, 42752, 0);
		EV_CameraPos(0, 105, 121.4836f, 6.3870001f, 732.08002f);
		EV_CameraAng(0, 105, 1024, 39424, 0);
		EV_ClrAction(player);
		EV_ClrAction(p_fpack1);
		...
		EV_CameraAng(0, 0, 3584, 40704, 0);
		EV_CameraPos(0, 95, 124.37f, 4.54f, 734.20001f);
		EV_CameraAng(0, 95, 3584, 36352, 0);
		...
		EV_CameraAng(0, 75, 3584, 36352, 0);
		...
		EV_CameraAng(1, 0, 65280, 10789, 63744);
		...
		EV_SetAng(m_sonic, 0, 9984, 0x4000);
		...
		EV_ClrPath(player);
		EV_ClrPath(sonic);
		EV_CameraAng(1, 0, 0, 4133, 0);
		EV_CameraPos(1, 0, 2845.0f, 263.0f, 861.0f);
		EV_CameraAng(0, 80, 768, 4133, 64768);
		...
		EV_CameraAng(0, 55, 2560, 32512, 0);
		EV_MsgClose();
		EV_Wait(35);
		if (task_frame)
		{
		...
		EV_CameraAng(0, 0, 62208, 62720, 0);
		EV_CameraPos(0, 180, 127.36f, 8.8000002f, 701.966f);
		EV_CameraAng(0, 180, 62464, 65024, 0);
		EV_RemovePlayer(2);
		EV_SerifPlay(840);
		...
		EV_CameraPerspective(0, 160, 7282);
		EV_CameraPos(0, 160, 134.0f, 8.5f, 702.90002f);
		EV_CameraAng(0, 160, 63488, 7168, 0);
		EV_Wait(20);
		EV_LookFree(player);
		EV_LookPoint(player, 127.0f, 11.0f, 720.0f);
		EV_SerifWait();
		...
		EV_CameraAng(0, 140, 512, 11776, 512);
		EV_Wait(16);
		EV_SerifPlay(842);
		...
		EV_CameraAng(1, 0, 63488, 24064, 0);
		EV_CameraPos(1, 180, 132.62f, 5.7680001f, 689.63702f);
		EV_CameraAng(1, 180, 512, 24064, 0);
		...
		EV_Wait(40);
		EV_CameraAng(0, 50, 62208, 24064, 0);
