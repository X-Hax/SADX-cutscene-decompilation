...
void ev006E_a_junglebase(int state)
{
    ...
    case 1:
        ...
        EV_SetAng(bird, 0, 21329, 0);
        EV_Wait(1);
        EV_SetMode(bird, 0);
        EV_SetPos(bird, 79.220001f, 6.0100002f, -1635.8101f);
        EV_SetAng(bird, 0, 40556, 0);
        EV_ClrAction(bird);
