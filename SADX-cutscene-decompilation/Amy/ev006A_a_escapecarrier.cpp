...
void ev006A_a_escapecarrier(int state)
{
	...
	case 1:
		...
		EV_CameraAng(1, 0, 0x200, 0x8700, 0);
		EV_Wait(10);
		...
		EV_CameraAng(0, 0, 0x680, 0xEDB3, 0);
		EV_CameraPos(0, 70, -18.040001f, 1529.5699f, 3437.03f);
		EV_CameraAng(0, 70, 0x680, 0xF3B3, 0);
		EV_Wait(60);
		EventSe_Oneshot(1334, 0, 0, 0);
		EV_Wait(40);
		...
		EV_MovePoint(sonic,
			...
			sonic->twp->pos.y,
			sonic->twp->pos.z + 60.0f);
		EV_CameraAng(0, 0, 0xEF00, 0x9000, 0x500);
		EV_CameraPos(0, 0, -16.639999f, 1565.87f, 3262.8401f);
		EV_CameraAng(0, 35, 0x200, 0x9000, 0x600);
		EV_CameraPos(0, 35, -9.7600002f, 1526.92f, 3337.49f);
		EV_Wait(30);
		EV_CameraAng(0, 15, 0xF00, 0x9500, 0x700);
		...
		EV_CameraAng(0, 160, 0x600, 0x6500, 0x700);
		EV_ClrAction(player);
		...
		EV_CameraAng(1, 0, 0x1300, 0x1100, 0);
		...
		EV_CameraAng(0, 4, 0x1280, 0x5D00, 0x500);
		EV_Wait(3);
		...
		EV_CameraAng(0, 40, 0x80, 0x2A00, 0);
		EV_MsgClose();
