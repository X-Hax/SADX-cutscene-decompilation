...
void ev0067_a_past(int state)
{
	...
	case 1:
		...
		EV_CameraAng(1, 0, 0xF00, 0x7E00, 0xFD00);
		EV_CameraPos(1, 100, 0.44999999f, 14.3f, 1385.89f);
		EV_CameraAng(1, 100, 0xF00, 0x8000, 0xFD00);
