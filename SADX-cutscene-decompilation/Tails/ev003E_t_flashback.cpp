...
void ev003E_t_flashback(int state)
{
	...
	case 1:
		...
		EV_CameraAng(1, 0, 0x700, 0xA400, 0x300);
		EV_CameraPos(1, 80, -963.79999f, 12.6f, -189.75f);
		EV_CameraAng(1, 80, 0x933, 0xA057, 0x300);
		EV_Wait(100);
		...
		EV_SetAng(player, 0xFB00, 0xDA00, 0);
		EV_SetPos(sonic, -836.70001f, 24.77f, 144.89999f);
		EV_SetAng(sonic, 0xFB00, 0xE000, 0);
		...
		EV_CameraAng(1, 0, 0xDC9, 0xD6AB, 0);
		EV_CameraPos(1, 160, -1078.6f, 0.80000001f, -1438.27f);
		EV_CameraAng(1, 160, 0xBC9, 0xDCAB, 0xFF00);
