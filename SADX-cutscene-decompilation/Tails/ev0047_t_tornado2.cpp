...
void ev0047_t_tornado2(int state)
{
	...
	case 1:
		...
		EV_CameraAng(0, 0, 4096, 14592, 65024);
		EV_CameraPerspective(1, 30, 10194);
		EV_SerifPlay(755);
		...
		EV_CameraAng(0, 0, 1792, 17632, 65504);
		EV_Wait(5);
		EV_CameraPos(0, 50, 453.79999f, -281.14999f, 305.88f);
		EV_CameraAng(0, 50, 5888, 25808, 65280);
		EV_Wait(50);
		EventSe_Stop(0);
		EV_CameraPos(0, 0, 404.88f, 374.5f, 1676.3f);
		EV_CameraAng(0, 0, 61904, 1632, 0);
		...
		EV_CameraAng(0, 0, 1488, 38400, 512);
		EV_CameraPos(0, 80, 433.60001f, -273.56601f, 311.66449f);
		EV_CameraAng(0, 80, 1488, 44032, 512);
		EV_Wait(5);
		seqVars[35] = 3;
		...
		EV_CameraAng(0, 0, 2256, 3584, 65280);
