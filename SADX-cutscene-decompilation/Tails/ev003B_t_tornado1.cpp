...
void ev003B_t_tornado1(int state)
{
	...
	case 1:
		...
		EV_SetAng(player, 0, 25934, 0);
		EV_Wait(1);
		EV_CameraPos(1, 0, 1430.46f, 209.28f, 798.78998f);
		EV_CameraAng(1, 0, 65280, 54528, 0);
		EV_CameraPerspective(1, 1, 22756);
		...
		EV_CameraAng(1, 190, 62976, 39424, 0);
		EV_Wait(320);
		EventSe_Stop(1);
