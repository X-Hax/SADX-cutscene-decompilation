...
void ev0051_t_walkerdefeated(int state)
{
	...
	case 1:
		...
		EV_SetMode(OYAJI, 0);
		EV_ClrAction(OYAJI);
		EV_SetMotion(OYAJI, *MODEL_SS_PEOPLE_OBJECTS, MODEL_SS_PEOPLE_MOTION[1], ADV00_TEXLISTS[6], 0.5f, 1, 0);
		EV_SetMode(FAT_B, 0);
		EV_ClrAction(FAT_B);
		EV_SetMotion(FAT_B, MODEL_SS_PEOPLE_OBJECTS[15], MODEL_SS_PEOPLE_MOTION[23], ADV00_TEXLISTS[6], 0.5f, 1, 0);
		EV_SetMode(LADY, 0);
		EV_ClrAction(LADY);
		...
		EV_SetMode(FAT2, 0);
		EV_ClrAction(FAT2);
		EV_SetMotion(FAT2, MODEL_SS_PEOPLE_OBJECTS[16], MODEL_SS_PEOPLE_MOTION[23], ADV00_TEXLISTS[6], 0.5f, 1, 0);
		EV_SetMode(LADY2, 0);
		EV_ClrAction(LADY2);
		EV_SetMotion(LADY2, MODEL_SS_PEOPLE_OBJECTS[5], MODEL_SS_PEOPLE_MOTION[8], ADV00_TEXLISTS[6], 0.5f, 1, 0);
		EV_SetMode(GIRL2, 0);
		EV_ClrAction(GIRL2);
		EV_SetMotion(GIRL2, MODEL_SS_PEOPLE_OBJECTS[11], MODEL_SS_PEOPLE_MOTION[12], ADV00_TEXLISTS[6], 0.5f, 1, 0);
		EV_SetFace(player, "K");
		EV_Wait(40);
		EV_ClrFace(player);
		if (!VoiceLanguage)
