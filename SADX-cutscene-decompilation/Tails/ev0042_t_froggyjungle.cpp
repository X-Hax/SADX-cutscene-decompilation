...
void ev0042_t_froggyjungle(int state)
{
	...
	case 1:
		...
		EV_CameraAng(0, 30, 58112, 57284, 0);
		EV_Wait(30);
		EV_ClrFace(player);
		...
		EV_CameraAng(0, 0, 1024, 25796, 63744);
		EV_CameraPos(0, 150, -1168.37f, 47.0f, -229.3f);
		EV_CameraAng(0, 150, 1024, 25796, 63744);
		...
		EV_CameraAng(0, 0, 62976, 59844, 0);
		EV_Wait(20);
		EventSe_Oneshot(1334, 0, 0, 0);
		EV_Wait(5);
		...
		EV_CameraAng(0, 0, 5273, 23236, 0);
		EV_CameraPos(0, 60, -1179.08f, 47.169998f, -200.96001f);
		EV_CameraAng(0, 60, 5273, 23236, 0);
		EV_SetPos(Frog, -1250.16f, 75.0f, -158.41f);
		EV_SetAng(Frog, 61377, 56602, 60300);
		EV_Wait(1);
