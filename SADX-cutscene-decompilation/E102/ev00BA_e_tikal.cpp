...
void ev00BA_e_tikal(int state)
{
	...
	case 1:
		...
		EV_SetAng(tikal, 0, 45568, 0);
		EV_SetPos(CHAO1, 0.0f, 3.0f, 351.0f);
		EV_SetAng(CHAO1, 0, 0, 0);
		EV_SetPos(CHAO2, -14.0f, 1.5f, 360.0f);
		EV_SetAng(CHAO2, 0, 42240, 0);
		EV_SetPos(CHAO3, 14.0f, 1.5f, 360.0f);
		EV_SetAng(CHAO3, 0, 25856, 0);
		EV_SetPos(CHAO4, -5.0f, 1.5f, 370.0f);
		EV_SetAng(CHAO4, 0, 33536, 0);
		EV_SetPos(CHAO5, 5.0f, 1.5f, 370.0f);
		EV_SetAng(CHAO5, 0, 32000, 0);
		EV_SetPos(CHAO6, -23.0f, 1.5f, 363.0f);
		EV_SetAng(CHAO6, 0, 34048, 0);
		EV_SetPos(CHAO7, -13.0f, 1.5f, 370.0f);
		EV_SetAng(CHAO7, 0, 33280, 0);
		EV_SetPos(CHAO8, 0.0f, 1.5f, 376.0f);
		EV_SetAng(CHAO8, 0, 0x8000, 0);
		EV_SetPos(CHAO9, 14.0f, 1.5f, 370.0f);
		EV_SetAng(CHAO9, 0, 32256, 0);
		EV_SetPos(CHAO10, 23.0f, 1.5f, 363.0f);
		EV_SetAng(CHAO10, 0, 31488, 0);
		EV_SetPos(CHAO11, -18.0f, 1.5f, 347.0f);
		EV_SetAng(CHAO11, 0, 64512, 0);
		EV_SetPos(CHAO12, 18.0f, 1.5f, 347.0f);
		EV_SetAng(CHAO12, 0, 1024, 0);
		EV_SetPos(CHAO13, -20.0f, 1.5f, 380.0f);
		EV_SetAng(CHAO13, 0, 32512, 0);
		EV_SetPos(CHAO14, -6.0f, 1.5f, 383.0f);
		EV_SetAng(CHAO14, 0, 33024, 0);
		EV_SetPos(CHAO15, 20.0f, 1.5f, 380.0f);
		EV_SetAng(CHAO15, 0, 0x8000, 0);
		EV_SetPos(CHAO16, 6.0f, 1.5f, 383.0f);
		EV_SetAng(CHAO16, 0, 32512, 0);
		EV_SetAction(CHAO1, &action_al_sing_al_model, *ADV03_TEXLISTS, 0.85000002f, 1, 0);
		EV_SetAction(CHAO2, &action_al_sing_al_model, *ADV03_TEXLISTS, 1.0f, 1, 0);
		EV_SetAction(CHAO3, &action_al_sing_al_model, *ADV03_TEXLISTS, 0.87f, 1, 0);
		EV_SetAction(CHAO4, &action_al_sing_al_model, *ADV03_TEXLISTS, 0.80000001f, 1, 0);
		EV_SetAction(CHAO5, &action_al_sing_al_model, *ADV03_TEXLISTS, 0.88999999f, 1, 0);
		EV_SetAction(CHAO6, &action_al_sing_al_model, *ADV03_TEXLISTS, 0.87f, 1, 0);
		EV_SetAction(CHAO7, &action_al_sing_al_model, *ADV03_TEXLISTS, 1.1f, 1, 0);
		EV_SetAction(CHAO8, &action_al_sing_al_model, *ADV03_TEXLISTS, 1.05f, 1, 0);
		EV_SetAction(CHAO9, &action_al_sing_al_model, *ADV03_TEXLISTS, 0.88999999f, 1, 0);
		EV_SetAction(CHAO10, &action_al_sing_al_model, *ADV03_TEXLISTS, 0.88499999f, 1, 0);
		EV_SetAction(CHAO11, &action_al_sing_al_model, *ADV03_TEXLISTS, 1.03f, 1, 0);
		EV_SetAction(CHAO12, &action_al_sing_al_model, *ADV03_TEXLISTS, 1.05f, 1, 0);
		EV_SetAction(CHAO13, &action_al_sing_al_model, *ADV03_TEXLISTS, 0.83999997f, 1, 0);
		EV_SetAction(CHAO14, &action_al_sing_al_model, *ADV03_TEXLISTS, 0.80000001f, 1, 0);
		EV_SetAction(CHAO15, &action_al_sing_al_model, *ADV03_TEXLISTS, 0.80000001f, 1, 0);
		EV_SetAction(CHAO16, &action_al_sing_al_model, *ADV03_TEXLISTS, 1.1f, 1, 0);
		...
		EV_Wait(5);
		EV_SetAng(player, 1280, 0x8000, 69);
		EV_CameraPos(1, 0, -4.8000002f, -6.0f, 492.39999f);
		EV_CameraAng(1, 0, 1792, 62464, 0);
		EV_CameraPos(1, 140, -11.8f, -5.2600002f, 491.54999f);
		EV_CameraAng(1, 140, 1792, 63488, 0);
		...
		EV_Wait(80);
		EV_CameraPos(1, 0, 13.2f, 2.1800001f, 354.17001f);
		EV_CameraAng(1, 0, 1024, 32824, 0);
		EventSe_Oneshot(1337, 30, 0, 0);
		EV_Wait(25);
		EventSe_Oneshot(1337, 20, 40, 0);
		EV_Wait(15);
		EV_CameraPos(1, 100, 11.25f, 2.2f, 354.26001f);
		EV_CameraAng(1, 100, 1024, 32824, 0);
		...
		EV_CameraAng(1, 0, 1280, 64289, 512);
		EV_CameraPos(0, 90, 0.0f, 3.1199999f, 382.20001f);
		EV_CameraAng(0, 90, 2560, 0, 0);
		...
		EV_SetAng(tikal, 0, 25344, 0);
		EV_CameraPos(1, 0, -8.1800003f, 20.1f, 400.64999f);
		EV_CameraAng(1, 0, 61440, 62753, 768);
		EV_CameraPos(1, 90, -9.6599998f, 26.4f, 405.0f);
		EV_CameraAng(1, 90, 60160, 62753, 768);
		...
		EV_CameraAng(1, 0, 59648, 26401, 0);
		EV_CameraPos(0, 120, -21.73f, 6.3000002f, 410.39999f);
		EV_CameraAng(0, 120, 63232, 26401, 0);
		EV_Wait(120);
		EV_ClrFace(tikal);
		...
		EV_CameraAng(1, 0, 64000, 35873, 0);
		EV_CameraPos(1, 300, 10.57f, 6.0f, 338.60001f);
		EV_CameraAng(1, 300, 64256, 29473, 0);
		EV_ClrFace(tikal);
		...
		EV_CameraAng(1, 0, 65017, 28449, 0);
		EV_CameraPos(1, 140, 1.38f, 10.3f, 370.5f);
		EV_CameraAng(1, 140, 512, 31009, 0);
		...
		EV_CameraAng(1, 0, 512, 31009, 0);
		EV_CameraPos(1, 230, -27.129999f, 9.0f, 376.17999f);
		EV_CameraAng(1, 230, 0, 40993, 0);
		...
		EV_CameraAng(1, 0, 1280, 61985, 0);
		EV_CameraPos(1, 180, -25.57f, 5.0999999f, 419.56f);
		EV_CameraAng(1, 180, 1280, 61985, 0);
		EV_SerifPlay(1222); 
