...
void ev00BF_e_prison(int state)
{
	...
	case 1:
		...
		EV_CreatePlayer(2, AmyRose, -100.0f, 0.1f, -33.369999f, 0, 61973, 0);
		...
		EV_SetAng(obj_ver1_wing, 0, 61973, 0);
		...
		EV_CameraAng(0, 0, 65024, 49152, 0);
		...
		EV_CameraAng(0, 45, 64512, 58880, 0);
