...
//		obj_amy = 0; //Needs to use DataPointer for now, because the functions related to task_gattai need to be rewritten to make this way work.
		...
		EV_SetAng(amy, 0, 1024, 0);
		EV_CameraPos(0, 0, -41.700001f, 1531.13f, 3322.2f);
		EV_CameraAng(0, 0, 2392, 4607, 0);
		EV_ClrAction(amy);
		EV_SetAction(amy, &action_a_a0004_amy, &AMY_TEXLIST, 0.80000001f, 1, 16);
		...
		EV_CameraAng(1, 0, 1024, 30464, 1792);
		EV_CameraPos(1, 80, 6.5f, 1533.3f, 3310.3999f);
		EV_CameraAng(1, 80, 256, 29952, 1792);
		EV_ClrAction(sonic);
		...
		EV_CameraAng(1, 0, 57856, 256, 0);
		EV_CameraPos(1, 90, -3.4000001f, 1535.0428f, 3343.0f);
		EV_CameraAng(1, 90, 57856, 256, 0);
		EV_ClrFace(amy);
		...
		EV_CameraAng(0, 150, 1536, 27136, 0);
		...
		EV_CameraAng(1, 140, 1536, 28416, 0);
		...
		EV_CameraPerspective(1, 60, 10377);
		EV_CameraPos(0, 0, 26.4f, 1542.8f, 3328.8f);
		EV_CameraAng(0, 0, 61440, 25153, 256);
		EV_Wait(10);
		EV_CameraPos(0, 70, 19.889999f, 1543.4f, 3318.6299f);
		EV_CameraAng(0, 70, 62720, 25153, 1280);
		EV_Wait(3);
		...
		RumbleA(0, 3);
		EV_CameraAng(0, 5, 64768, 25153, 1280);
		EV_Wait(3);
		EV_CameraAng(0, 5, 62720, 25153, 1280);
		EV_Wait(3);
		EV_CameraAng(0, 5, 64768, 25153, 1280);
		EV_Wait(3);
		EV_CameraAng(0, 5, 62720, 25153, 1280);
		...
		EV_CameraAng(0, 5, 64000, 25153, 1280);
		EV_Wait(3);
		EV_CameraAng(0, 5, 62720, 25153, 1280);
		EV_Wait(3);
		EV_CameraAng(0, 5, 64000, 25153, 1280);
		...
		EV_CameraAng(0, 5, 62720, 25153, 1280);
		EV_Wait(3);
		EV_CameraAng(0, 5, 62976, 25153, 1280);
		EV_Wait(3);
		EV_CameraAng(0, 5, 62720, 25153, 1280);
		EV_Wait(3);
		EV_CameraAng(0, 5, 62976, 25153, 1280);
		...
		EV_CameraAng(0, 0, 896, 39168, 768);
		...
		EV_CameraAng(0, 0, 61056, 8704, 768);
		...
		EV_LookObject(amy, sonic, 0.0f, 6.0f, 0.0f);
		EV_CameraAng(1, 70, 63360, 7168, 0);
		EV_Wait(85);
		EV_SetPos(amy, -3.55f, 1525.7f, 3339.02f);
		EV_SetAng(amy, 0, 40960, 0);
		EV_LookFree(amy);
		...
		EV_CameraAng(1, 170, 3072, 23296, 0);
		EV_MoveFree(sonic);
		EV_ClrAction(sonic);
		...
		EV_CameraAng(1, 120, 3072, 23296, 0);
		EV_SerifPlay(1300);
		...
		EV_CameraAng(1, 0, 58112, 512, 512);
		...
		EV_CameraAng(1, 80, 61440, 512, 512);
		EV_ClrFace(amy);
		if (VoiceLanguage == Languages_Japanese)
		{
			EV_SetFace(amy, "CCA");
		...
		EV_Wait(65);
		EV_ClrFace(amy);
		EV_CameraAng(1, 25, 62720, 5632, 0);
		EV_LookFree(amy);
		...
		EV_Wait(50);
		EV_CameraTargetFree();
		EV_CameraAng(1, 41, 4222, 22797, 1280);
		EV_Wait(30);
