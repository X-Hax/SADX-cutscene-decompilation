...
void ev00BB_e_deliverfrog(int state)
{
	...
	case 1:
		...
		EV_CameraAng(1, 0, 59648, 0x8000, 0);
		...
		EV_SetAction(Frog1, &_action_f_f0003_frog, &texlist_frog, 0.80000001f, 1, 0);
		EV_Wait(10);
		EV_CameraAng(1, 0, 4352, 29440, 256);
		...
		EV_Wait(87);
		EV_CameraAng(1, 0, 65280, 60672, 256);
		...
		EV_Wait(15);
		EV_CameraChaseFree();
		EV_CameraAng(1, 0, 64256, 44800, 256);
		...
		EV_CameraPerspective(0, 120, 10741);
		EV_CameraAng(0, 120, 320, 59136, 0);
		...
		EV_CameraAng(1, 0, 64064, 23808, 0);
		EV_CameraPos(1, 0, -13.46f, 19.190001f, -72.660004f);
		EV_CameraAng(1, 120, 832, 24320, 0);
		...
		EV_CameraAng(1, 70, 62528, 30720, 0);
		EV_CameraPos(1, 70, 4.3299999f, 21.4f, -93.650002f);
		EV_CameraPerspective(1, 70, 18204);
		EV_SerifPlay(1234);
		...
		EV_MoveRotation(player, 0, 30208, 0);
		...
		EV_Wait(20);
		EventSe_Stop(0);
		EV_CameraAng(0, 80, 1344, 41728, 65024);
		EV_CameraPos(0, 80, -38.0f, 9.243f, -59.056f);
		EV_Wait(30);
		EV_SetAng(e103, 0, 20480, 0);
		EV_SetAng(e104, 0, -28672, 0);
		EV_SetAng(e105, 0, -25856, 0);
		EV_Wait(50);
		...
		EV_CameraAng(1, 90, 3136, 22784, 0);
		...
		EV_SerifWait();
		EV_MsgClose();
		EV_CameraAng(0, 90, 64577, 30464, 0);
		...
		EV_Wait(10);
		EV_CameraAng(0, 210, 64, 33792, 0);
		EV_CameraPos(0, 210, -71.599998f, 10.0f, 21.4f);
		EV_CameraPerspective(0, 210, 7282);
		EV_Wait(70);
		EV_SerifPlay(1237);
		...
		EV_CameraAng(1, 0, 3904, 6656, 0);
		EV_CameraPos(1, 0, -12.22f, -3.925f, -19.747999f);
		EV_CameraAng(0, 40, 1600, 5632, 256);
