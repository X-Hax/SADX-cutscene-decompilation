...
void ev00C1_e_sonic(int state)
{
	...
	case 1:
		...
		EV_CreatePlayer(5, AmyRose, -20.0f, 1525.6f, 3292.6599f, 0, 0x4B70, 0);
		EV_Wait(1);
		...
		EV_CameraAng(0, 120, 0xC91, 0x11F2, 0);
		...
		EV_CameraAng(0, 160, 0xA22, 0x1214, 0);
		EV_Wait(50);
		EV_MsgClose();
		eggmoble_turn(0, -0x4000, 0, 50, 0);
		EV_Wait(54);
		eggmoble_moveandturn(-74.300003f, 1570.5f, 3240.8999f, 0, -0x4000, 0, 85, 0);
		EV_Wait(89);
		ChgEggMobleSMod(1);
		EV_Wait(1);
