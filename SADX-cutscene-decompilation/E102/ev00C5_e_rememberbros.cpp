...
void ev00C5_e_rememberbros(int state)
{
	...
	case 1:
		...
		EV_CameraAng(0, 0, 64790, 16780, 0);
		EV_CameraPos(0, 200, -1923.66f, -334.98001f, 1656.95f);
		EV_CameraAng(0, 200, 64790, 16780, 0);
		...
		EV_CameraAng(0, 10, 4630, 16780, 0);
		...
		EV_CameraAng(0, 0, 65354, 57816, 0);
		EV_CameraPos(0, 100, -1948.08f, -335.81f, 1677.95f);
		EV_CameraAng(0, 100, 65354, 57816, 0);
		EV_SetPos(player, -1924.08f, -353.19f, 1647.25f);
		EV_SetAng(player, 0, 22653, 0);
		EV_ClrAction(player);
