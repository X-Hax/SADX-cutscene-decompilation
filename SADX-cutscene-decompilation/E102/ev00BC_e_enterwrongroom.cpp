...
void ev00BC_e_enterwrongroom(int state)
{
	...
	case 1:
		...
		EV_CameraAng(0, 0, 63744, 32512, 0);
		EV_CameraPos(0, 100, 0.2f, 48.099998f, -46.299999f);
		EV_CameraAng(0, 100, 64256, 32512, 0);
		EV_Wait(100);
		seqVars[37] |= 1u;
		EV_CameraPos(1, 100, 0.30000001f, 18.5f, -50.5f);
		EV_CameraAng(1, 100, 65280, 32512, 0);
		EV_Wait(100);
		seqVars[37] |= 1u;
		EV_CameraPos(1, 170, 44.0f, 12.7f, -9.0f);
		EV_CameraAng(1, 170, 65280, 27392, 0);
		EV_Wait(100);
		seqVars[37] |= 1u;
		EV_SerifPlay(1239);
