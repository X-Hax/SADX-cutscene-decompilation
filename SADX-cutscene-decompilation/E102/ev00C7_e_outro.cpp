...
void ev00C7_e_outro(int state)
{
	...
	case 1:
		...
		EV_SetAng(E101KAI, 464, 9248, 651);
		if (enableUnusedCode) {
		...
		EV_CameraAng(1, 0, 3584, 11296, 1536);
		EV_CameraPos(0, 90, 13.8f, 745.37598f, -220.75f);
		EV_CameraAng(0, 90, 4608, 13600, 1536);
		EV_Wait(30);
		...
		EV_CameraAng(0, 120, 4586, 15087, 1792);
		EV_Wait(90);
		moveObjectAngle2(
			E101KAI,
		...
		EV_CameraAng(0, 1, 4842, 15087, 1792);
		EV_Wait(2);
		moveObject(E101KAI, -108.23f, 760.0f, -306.56f, -108.23f, 759.0f, -306.56f, 1);
		EV_CameraAng(0, 1, 4330, 15087, 1792);
		EV_Wait(1);
		EV_CameraAng(0, 1, 4586, 15087, 1792);
		...
		EV_Wait(50);
		EV_CameraPerspective(0, 66, 10923);
		EV_CameraPos(0, 0, -32.700001f, 762.59998f, -243.60001f);
		EV_CameraAng(0, 0, 62464, 9216, 0);
		EV_Wait(1);
		...
		EV_CameraAng(0, 100, 3072, 11264, 0);
		...
		EV_Wait(10);
		EV_CameraAng(0, 60, 3072, 12032, 0);
		...
		EV_CameraAng(0, 60, 3328, 14848, 256);
		EV_Wait(10);
		if (bomb1)
		{
			FreeTask(bomb1);
		...
		EV_SetAng(bird1, 0, 40960, 0);
		EV_SetAction(bird1, &action_w_t0001_wing_t, &texlist_wing_t, 1.0f, 1, 8);
		EV_Wait(55);
		EV_CameraChaseFree();
		EV_CameraPos(1, 20, 20.4f, 754.0f, -187.37f);
		EV_CameraAng(1, 20, 4096, 8704, 0);
		EV_Wait(20);
		...
		EV_CameraAng(0, 60, 4096, 28672, 0);
		EV_Wait(20);
		EV_SetAng(bird1, 0, 4096, 0);
		moveObject(bird1, 31.9f, 758.0f, -205.47f, 8.3500004f, 758.0f, -213.8f, 150);
		EV_Wait(20);
		moveObjectAngle2(player, 4.9699998f, 743.68439f, -202.06f, 25.5f, 744.0f, -202.2f, 791, 5376, 0, 791, 0, 0, 180);
		EV_Wait(130);
		stopObjectAll();
		EventSe_Stop(1);
		EV_Wait(1);
		...
		EV_CameraAng(0, 0, 512, 10752, 256);
		EV_CameraPos(0, 400, 47.5f, 761.0f, -191.0f);
		EV_CameraAng(0, 400, 64768, 12288, 256);
		...
		EV_CameraAng(1, 0, 5632, 10240, 256);
		EV_Wait(56);
		EV_CameraPos(1, 0, 31.5f, 761.06f, -206.39999f);
		EV_CameraAng(1, 0, 64960, 12032, 256);
		EV_CameraPos(0, 194, 47.5f, 761.0f, -191.0f);
		EV_CameraAng(0, 194, 64768, 12288, 256);
		EV_Wait(30);
		...
		EV_CameraAng(1, 0, 2816, 768, 0);
		EV_Wait(53);
		EV_CameraPos(1, 0, 41.57f, 761.20001f, -197.03661f);
		EV_CameraAng(1, 0, 64978, 12029, 256);
		EV_CameraPos(0, 80, 47.5f, 761.0f, -191.0f);
		EV_CameraAng(0, 80, 64768, 12288, 256);
		if (WHITE2)
		{
			COverlaySetSpeed(WHITE2, 0.33333334f);
		}
		...
		EV_CameraAng(0, 100, 63488, 12288, 256);
		...
		EV_CameraAng(1, 0, 63392, 34656, 0);
		...
		EV_CameraAng(1, 0, 1504, 3216, 0);
		EV_CameraPos(0, 200, 45.200001f, 770.39001f, -49.176998f);
		EV_CameraAng(0, 200, 512, 4096, 0);
		EV_Wait(50);
		...
		EV_CameraAng(1, 0, 62720, 42752, 1792);
		EV_CameraChase(bird1);
		EV_Wait(1);
		...
		EV_CameraAng(1, 0, 3584, 63488, 1792);
		...
		EV_CameraAng(1, 0, 61952, 35072, 1536);
		EV_CameraChase(bird1);
		EV_Wait(120);
		EV_CameraChaseFree();
		EV_CameraPos(1, 0, -57.276001f, 823.0f, -399.79999f);
		EV_CameraAng(1, 0, 3584, 64000, 1536);
		EV_Wait(130);
		EV_CameraPos(0, 100, -59.400002f, 831.78003f, -414.17599f);
		EV_CameraAng(0, 100, 4096, 60160, 1536);
		EV_Wait(60);
