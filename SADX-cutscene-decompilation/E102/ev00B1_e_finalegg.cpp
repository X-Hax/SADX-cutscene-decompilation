...
void ev00B1_e_finalegg(int state)
{
	...
	case 1:
		...
		EV_SetAng(eggman, 65504, 53122, 0);
		EV_ClrAction(eggman);
		...
		EV_CameraAng(0, 0, 59648, 32909, 0);
		EV_MsgClose();
		EV_Wait(90);
		break;
	case 2:
