...
void ev00B4_e_e101(int state)
{
	...
	case 1:
		...
		EV_SetPos(player, -15.54f, 0.44999999f, -10.36f);
		EV_SetAng(player, 0, 51409, 0);
		EV_CameraPos(0, 0, -2.1700001f, 20.440001f, 2.1900001f);
		EV_CameraAng(0, 0, 61861, 15696, 0);
		EV_ClrAction(player);
		EV_SetAction(player, E102_ACTIONS[0], &E102_TEXLIST, 1.0f, 1, 0);
		EV_Wait(30);
		...
		EV_SetAng(eggman, 0, 19122, 0);
		EV_CameraPos(0, 0, -48.040001f, 15.28f, -3.1099999f);
		EV_CameraAng(0, 0, 65189, 48464, 0);
		EV_SerifPlay(1188);
		...
		EV_CameraAng(0, 0, 1957, 56144, 0);
		EV_Wait(1);
		EV_CameraPos(0, 0, -49.369999f, 8.3199997f, 21.559999f);
		EV_CameraAng(0, 0, 1701, 56144, 0);
		EV_Wait(1);
		EV_CameraPos(0, 0, -49.369999f, 8.3199997f, 21.559999f);
		EV_CameraAng(0, 0, 1957, 56144, 0);
		EV_Wait(2);
		...
		EV_SetAng(eggman, 0, 47672, 0);
		EV_CameraPos(0, 100, -59.709999f, 7.0900002f, 24.040001f);
		EV_CameraAng(0, 100, 677, 56912, 0);
		...
		EV_CameraAng(0, 100, 61861, 45904, 0);
		EV_Wait(60);
