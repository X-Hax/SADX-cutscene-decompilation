...
void ev00B3_e_uselessmachine(int state)
{
	...
	case 1:
		...
		EV_CameraAng(0, 0, 60672, 2034, 0);
		EV_SetPos(player, -1.77f, 108.68f, -173.03999f);
		EV_SetAng(player, 0, 64893, 0);
		EV_Wait(1);
		EV_ClrAction(player);
		...
		EV_SetAng(player, 65504, 7864, 0);
		EV_CameraPos(0, 0, 19.280001f, 125.16f, -150.64f);
		EV_CameraAng(0, 0, 63488, 42994, 0);
		...
		EV_CameraAng(0, 3, 63488, 42994, 0);
		EV_Wait(3);
		...
		EV_CameraAng(0, 10, 63488, 42994, 0);
		EV_Wait(10);
		...
		EV_CameraAng(0, 0, 64512, 56306, 0);
		EV_Wait(30);
		EV_MsgClose();
		EV_CameraPos(0, 20, 26.09f, 123.79f, -148.48f);
		EV_CameraAng(0, 20, 65280, 10994, 0);
		...
		EV_CameraAng(0, 0, 65280, 33010, 0);
		EV_SetPos(player, 0.75f, 108.76f, -148.38f);
		EV_SetAng(player, 0, 32036, 0);
		EV_ClrAction(player);
		EV_SetAction(player, E102_ACTIONS[4], &E102_TEXLIST, 1.0f, 1, 0);
