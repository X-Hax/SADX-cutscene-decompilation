...
{
    ObjectMaster* EV0020_CTikalLight = 0;
    ...
    case 1:
        ...
        EV0020_CTikalLight = CTikalLight_Create(-23.139999, 25.0, -1.6);
        EV_Wait(1);
        EV_SetMode(EV0020_CTikalLight, 0);
        ...
        EV_Wait(80);
        moveObject(EV0020_CTikalLight, -23.139999, 25.0, -1.6, -445.76001, 25.0, -11.85, 300);
        EV_Wait(20);
        ...
        EV_FreeObject(&EV0020_CTikalLight);
        stopObjectAll();
        EV_Wait(10);
        ...
        EV_SerifPlay(587);
        EV_Msg((msgTbl_ev0020[TextLanguage])[0]); //What's this?
        EV_Wait(70);
        ...
        EV_MsgW(0, (msgTbl_ev0020[TextLanguage])[1]); //A mural?
        EV_Wait(30);
        EV_MsgClose();
        EV_MsgClose();
    ...
    case 2:
        ...
        EV_CameraOff();
        EV_PadOn();
        if (EV0020_CTikalLight)
        {
            FreeTask(EV0020_CTikalLight);
            EV0020_CTikalLight = 0;
        }
        EV_FreeFadeToWhite();
        break;
    }
