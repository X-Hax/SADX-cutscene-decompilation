...
void ev0022_s_pastaltar(int state)
{
	...
	case 1:
		...
		EV_CreateObjectFunc(&CHA4, EV_Alife, -32.632999f, 1.0f, 399.72299f, 0, 49152, 0);
		EV_CreateObjectFunc(&CHA5, EV_Alife, 38.805f, 1.023f, 463.18201f, 0, 5632, 0);
		EV_CreateObjectFunc(&CHA6, EV_Alife, 37.573002f, 1.023f, 315.83499f, 0, 0, 0);
		EV_CreateObjectFunc(&CHA7, EV_Alife, -40.632999f, 1.0f, 400.72299f, 0, 12288, 0);
		EV_CreateObjectFunc(&CHA8, EV_Alife, 50.805f, 1.023f, 450.18201f, 0, 61440, 0);
		EV_CreateObjectFunc(&CHA9, EV_Alife, 47.573002f, 1.023f, 325.83499f, 40960, 0, 0);
		EV_CreateObjectFunc(&CHA10, EV_Alife, -30.632999f, 1.0f, 395.72299f, 12288, 0, 0);
		EV_Wait(1);
