...
void ev002B_s_beforechaos0(int state)
{
	...
	case 1:
		...
		EV_CreateObject(&PL_NOR_01, 339.60001f, 10.5895f, 329.38f, 0xF3, 0x97CF, 0xFF5E);
		EV_CreateObject(&PL_NOR_02, 336.45999f, 9.4595003f, 380.69f, 0, 0x9A4B, 0);
		EV_CreateObject(&PL_NOR_03, 279.14999f, 9.4595003f, 399.42999f, 0x103, 0x8BE1, 0xFFCD);
		EV_CreateObject(&PL_NOR_04, 301.14999f, 9.4595003f, 398.41f, 0, 0x88E4, 0);
		EV_CreateObject(&PL_NOR_05, 236.89f, 11.0395f, 330.35999f, 0x108, 0x726C, 0x34);
		EV_CreateObject(&PL_NOR_07, 339.60001f, 10.5895f, 329.38f, 0xF3, 0x97CF, 0xFF5E);
		EV_CreateObject(&PL_NOR_08, 336.45999f, 9.4595003f, 380.69f, 0, 0x9A4B, 0);
		...
		EV_CameraAng(0, 0, 0x1049, 0xA00, 0xFE00);
		EV_CameraPerspective(0, 100, 0x38E4);
		EV_CameraPos(0, 80, 286.29001f, 3.76f, 487.12f);
		EV_CameraAng(0, 80, 0x1466, 0xA00, 0xFE00);
		EV_Wait(70);
		...
		EV_CameraAng(0, 0, 0xCC00, 0x5F00, 0);
		...
		EV_CameraAng(0, 0, 0x3027, 0x2000, 0);
		EV_CameraPos(0, 60, 283.95001f, 53.119999f, 248.77f);
		EV_CameraAng(0, 60, 0x1800, 0x2000, 0);
		EV_Wait(46);
		dsPlay_oneshot_v(1342, 0, 0, 100, 271.60999f, 58.849998f, 227.0f);
		EV_CameraAng(0, 3, 0x1750, 0x2000, 0);
		EV_Wait(1);
		RumbleA(0, 1);
		EV_Wait(2);
		EV_CameraAng(0, 2, 0x1800, 0x2000, 0);
		EV_Wait(1);
		EV_CameraAng(0, 1, 0x1700, 0x2000, 0);
		EV_Wait(1);
		EV_CameraAng(0, 2, 0x1800, 0x2000, 0);
		EV_Wait(1);
		EV_CameraAng(0, 1, 0x1700, 0x2000, 0);
		...
		EV_CameraAng(0, 2, 0x1800, 0x2000, 0);
		EV_Wait(1);
		EV_CameraAng(0, 1, 0x1750, 0x2000, 0);
		EV_Wait(1);
		EV_CameraAng(0, 2, 0x1800, 0x2000, 0);
		EV_Wait(1);
		...
		EV_CameraAng(0, 0, 0xEB00, 0x8100, 0);
		...
		EV_CameraAng(0, 0, 0x6FB, 0x229E, 0);
		EV_Wait(1);
		...
		EV_SetAng(PL_NOR_01, 0, 0xA500, 0);
		EV_SetAng(PL_NOR_05, 0, 0x7000, 0);
		EV_SetAng(PL_NOR_07, 259, 0xA600, 0xAD);
		EV_SetAng(PL_NOR_08, 259, 0x5D00, 0xAD);
		EV_SetAction(PL_NOR_04, &action_mp_10012_POLICE, &texlist_mp_10000_POLICE, 1.0f, 1, 0);
		EV_Wait(60);
		EV_CameraTargetFree();
		EV_CameraAng(0, 15, 0xE8, 0x661C, 0);
		dsPlay_oneshot_v(1342, 0, 0, 100, 268.0f, 3.1499996f, 300.0f);
		RumbleA(0, 1);
		EV_Wait(15);
		EV_CameraPos(0, 100, 296.70999f, 11.05f, 253.35001f);
		EV_CameraAng(0, 100, 0x2C4, 0x6F28, 0);
		EV_Wait(20);
		...
		EV_MsgClose();
		EV_CameraPerspective(0, 1, 0x1C72);
		EV_CameraTargetObj(1, 0, ev_chaos0, 0.0f, -5.0f, 0.0f, 0xFD00);
		EV_CameraChaseRM(0, 100, ev_chaos0, 15.0f, 0, 0x2AAB, 0, 160.0f, 0, -10922, 0, 100.0f);
		...
		effect_create2(PL_NOR_01, 0, 9.1999998f, 0.75f, 1.0f, &ev_effect_list3);
		...
		effect_create2(PL_NOR_07, 1, 9.1999998f, 0.75f, 1.0f, &ev_effect_list3);
		effect_scl(1, 0.18000001f, 0.18000001f);
		EV_Wait(5);
		EV_SetAction(PL_NOR_01, &action_mp_10013_POLICE, &texlist_mp_10000_POLICE, 2.0f, 1, 0);
		effect_create2(PL_NOR_01, 2, 9.1999998f, 0.75f, 1.0f, &ev_effect_list3);
		...
		effect_create2(PL_NOR_02, 3, 9.1999998f, 0.75f, 1.0f, &ev_effect_list3);
		...
		effect_create2(PL_NOR_03, 4, 9.1999998f, 0.75f, 1.0f, &ev_effect_list3);
		effect_scl(4, 0.18000001f, 0.18000001f);
		EV_Wait(5);
		EV_SetAction(PL_NOR_04, &action_mp_10005_POLICE, &texlist_mp_10000_POLICE, 1.5f, 1, 0);
		effect_create2(PL_NOR_04, 5, 9.1999998f, 0.75f, 1.0f, &ev_effect_list3);
		...
		effect_create2(PL_NOR_05, 6, 9.1999998f, 0.75f, 1.0f, &ev_effect_list3);
		effect_scl(6, 0.18000001f, 0.18000001f);
		EV_Wait(5);
		EV_SetAction(PL_NOR_08, &action_mp_10005_POLICE, &texlist_mp_10000_POLICE, 2.5f, 1, 0);
		EV_SerifStop();
		effect_create2(PL_NOR_08, 7, 9.1999998f, 0.75f, 1.0f, &ev_effect_list3);
		...
		EV_CameraAng(0, 0, 0x39A, 0xEECA, 0x900);
		EV_Wait(10);
		EV_CameraPerspective(0, 1, 0x1555);
		EV_CameraPos(0, 0, 287.23999f, 7.8299999f, 327.20999f);
		EV_CameraAng(0, 0, 0x59A, 0x1DC8, 0xF900);
		EV_Wait(10);
		EV_CameraPos(0, 0, 269.37f, 21.02f, 328.67999f);
		EV_CameraAng(0, 0, 0xF49A, 0x1C8, 0xF800);
		...
		EV_CameraAng(0, 0, 0x840, 0x88E0, 0);
		EV_CameraPos(0, 180, 262.64001f, 1.78f, 327.48001f);
		EV_CameraAng(0, 180, 0x840, 0x88E0, 0);
		EV_SetAction(PL_NOR_02, &action_mp_10012_POLICE, &texlist_mp_10000_POLICE, 1.0f, 1, 0);
		EV_SetAction(PL_NOR_04, &action_mp_10004_POLICE, &texlist_mp_10000_POLICE, 1.0f, 1, 0);
		...
		EV_Wait(30);
		dsPlay_oneshot_v(1341, 0, 0, 280, 9.4595003f, 381.94f, 100.0f);
		effect_create2(PL_NOR_03, 0, 9.1999998f, 4.25f, 1.0f, &ev_effect_list3);
		effect_scl(0, 0.18000001f, 0.18000001f);
		EV_Wait(10);
		effect_delete(0);
		dsPlay_oneshot_v(1341, 1, 0, 280, 9.4595003f, 381.94f, 100.0f);
		effect_create2(PL_NOR_03, 1, 9.1999998f, 4.25f, 1.0f, &ev_effect_list3);
		effect_scl(1, 0.18000001f, 0.18000001f);
		EV_CameraPos(0, 50, 248.06f, 8.0900002f, 261.60999f);
		EV_CameraAng(0, 50, 0x440, 0x88E0, 0);
		EV_ClrAction(PL_NOR_08);
		...
		EV_SetAng(player, 0, 0x83BB, 0);
		EV_Wait(1);
		EV_ClrAction(player);
		EV_CameraPerspective(0, 1, 0x238E);
		EV_CameraPos(0, 0, 279.76001f, 19.530001f, 433.17999f);
		EV_CameraAng(0, 0, 0xFE30, 0x44D, 0);
		...
		EV_CameraAng(0, 0, 0xC15, 0x96B6, 0xFB00);
		EV_CameraPerspective(0, 20, 0x2AAB);
		EV_CameraPos(0, 20, 282.59f, 16.889999f, 426.82999f);
		EV_CameraAng(0, 20, 0x1015, 0x9BB6, 0xFB00);
