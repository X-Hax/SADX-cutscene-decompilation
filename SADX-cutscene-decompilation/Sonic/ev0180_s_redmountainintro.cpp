...
void ev0180_s_redmountainintro(int state)
{
	...
	case 1:
		...
		EventSe_Init(4);
		SetBankDir(78);
		createModelEC(-3857.7f, 2400.6001f, -2000.0f,0, 0x1000, 0, 0.1f, 0.1f, 0.1f, &object_ecff_bf_s_fbody_bf_s_fbody, &texlist_ec_light, 0);
		...
		EV_CameraAng(1, 0, 0xFDE, 0x2825, 0);
		EV_CameraPos(1, 400, -33.0f, 672.59998f, 589.59998f);
		EV_CameraAng(1, 400, 0x8DE, 0x2725, 0);
		EV_Wait(420);
		break;
	case 2:
		EV_CameraOff();
