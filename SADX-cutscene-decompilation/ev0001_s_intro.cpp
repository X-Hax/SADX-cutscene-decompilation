...
void ev0001_s_intro(int state)
{
    ...
    case 1:
        ...
        EV_CameraPos(0, fps * 150, 161.53999f, 14.44f, 1630.65f);
        EV_Wait(fps * 110);
        ...
        EV_CameraPos(0, fps * 150, 250.72f, 22.09f, 1183.03f);
        EV_Wait(fps * 110);
        moveObject(LADY_B, 197.89f, 10.85f, 1152.89f, 197.46001f, 10.85f, 1209.71f, fps * 210);
        EV_Wait(fps * 10);
        EV_CameraPos(0, 0, 297.07001f, 17.950001f, 1184.13f);
        EV_CameraAng(0, 0, 291, 0x4000, 0);
        EV_CameraPos(0, fps * 150, 298.79999f, 17.940001f, 1271.98f);
        moveObject(LADY_C, 172.95f, 10.85f, 1296.21f, 172.67999f, 10.85f, 1206.63f, fps * 240);
        moveObject(OYAJI_C, 182.66f, 9.8000002f, 1287.36f, 183.03999f, 10.85f, 1200.08f, fps * 240);
        EV_Wait(fps * 120);
        EV_CameraPerspective(0, 1, 12743);
        EV_CameraPos(1, 0, 621.21997f, 1.15f, 1035.13f);
        EV_CameraAng(1, 0, 4387, 18920, 0);
        EV_CameraPos(1, fps * 200, 614.96002f, 1.15f, 1009.89f);
        EV_SetPath(HELI_01, (EPATHTAG*)0x2C12710, 0.25f, 0);
        EV_Wait(fps * 20);
        EventSe_Play(0, 1334, fps * 1800);
        ...
        EV_CameraPos(0, fps * 150, 292.38f, 234.87f, 1164.73f);
        EV_CameraAng(0, fps * 150, 63232, 54507, 0);
        ...
        EV_CameraPos(1, fps * 30, 362.84f, 478.39999f, 1344.7f);
        ...
        EV_SetAction(player, SONIC_ACTIONS[1], &SONIC_TEXLIST, 1.0f / fps, 1, 0);
        EV_Wait(fps * 30);
        EV_SetAction(player, &action_s_s0064_sonic, &SONIC_TEXLIST, 2.0f / fps , 0, fps * 8);
        EV_SetAction(player, &action_s_s0065_sonic, &SONIC_TEXLIST, 2.0f / fps, 0, fps * 15);
        EV_SetAction(player, &action_s_s0066_sonic, &SONIC_TEXLIST, 2.0f / fps, 1, fps * 15);
        EV_SerifPlay(400);
        if (VoiceLanguage == 1)
        {
        ...
        EventSe_Play(5, 1335, fps * 1800);
        EventSe_Volume(5, 80, fps * 120);
        EventSe_Play(3, 1336, fps * 1800);
        EventSe_Volume(3, 100, fps * 60);
        EV_Wait(fps * 15);
        EventSe_Play(4, 1336, fps * 1800);
        EventSe_Volume(4, 100, fps * 30);
        EV_SerifPlay(402);
        ...
        EV_CameraPos(0, fps * 200, 316.22f, 493.31f, 1317.41f);
        ...
        EV_CameraTargetFree();
        EV_CameraPerspective(0, fps * 1, 10923);
        EV_CameraPos(0, 0, 123.08f, 2.2f, 1502.99f);
        EV_CameraAng(0, 0, 4807, 27722, 0);
        EV_CameraPos(0, fps * 90, 120.42f, 2.2f, 1501.59f);
        EV_Wait(fps * 10);
        EV_SerifPlay(403);
        EV_ClrFace(player);
        ...
        EV_CameraPos(0, fps * 90, 116.24f, 8.3999996f, 1525.95f);
        EV_CameraTargetObj(0, fps * 60, player, 0.0f, 6.0f, 0.0f, 0);
        EV_ClrAction(player);
