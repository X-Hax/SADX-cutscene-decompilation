...
void ev0091_k_leavepastsecond(int state)
{
	...
	case 1:
		...
		EV_SetAng(player, 0, 0x8900, 0);
		EV_CreatePlayer(2, E102, -37.299999f, -238.0f, 1973.0f, 0, 0, 0);
		EV_Wait(1);
		createModelEC(
			-2.7f, -160.60001f, 2153.3999f, 0, 0xAD00, 0, 0.0020000001f, 0.0020000001f, 0.0020000001f,
		...
		EV_CameraAng(1, 0, 0x24F, 0x667A, 0xFF00);
		...
		EV_CameraAng(1, 0, 0x84F, 0xD57A, 0xFF00);
		EV_CameraPos(1, 150, -23.700001f, -244.10001f, 2487.2f);
		EV_CameraAng(1, 150, 0x94F, 0xEE7A, 0xFF00);
		EV_ClrFace(player);
		...
		EV_CameraAng(1, 0, 0xF84F, 0xFC7A, 0);
		...
		EV_CameraAng(1, 0, 0x74F, 0x187A, 0x200);
		...
		EV_Wait(60);
		EV_CameraAng(0, 40, 0x304F, 0xBB7A, 0xE00);
		EV_Wait(40);
		...
		EV_CameraAng(1, 0, 0x84F, 0x697A, 0);
		...
		EV_CameraAng(1, 0, 0xA4F, 0xFB7A, 0);
		EV_Wait(80);
		EV_CameraPos(1, 0, 23.0f, -150.98f, 2192.0f);
		EV_CameraAng(1, 0, 0x24F, 0x277A, 0);
		...
		EV_CameraAng(1, 30, 0x84F, 0x1F7A, 0);
		...
		EV_CameraAng(1, 0, 0xE4F, 0x797A, 0);
		EV_CameraAng(1, 8, 0x184F, 0x777A, 0);
		EV_Wait(30);
		if (enableUnusedCode) {
		...
		EV_CameraPerspective(0, 70, 0x2AAB);
		EV_Wait(60);
		EV_ClrFace(player);
		EV_CameraPos(1, 0, -1.23f, -145.86f, 2177.0f);
		EV_CameraAng(1, 0, 0xC4F, 0x27A, 0);
		...
		EV_CameraAng(0, 0, 0x54F, 0xCE7A, 0);
		...
		EV_SetAng(e102, 0xFB00, 0xC47A, 0);
		EV_CameraPos(0, 0, -1516.1f, -402.20001f, 2132.3999f);
		EV_CameraAng(0, 0, 0xF4F, 0x357A, 0xFF00);
		...
		EV_Wait(85);
		EV_CameraTargetFree();
		EV_SetAng(player, 0x250, 0xA97A, 0);
		EV_CameraPos(1, 0, -1533.5f, -398.39999f, 2140.2f);
		EV_CameraAng(1, 0, 0x9E3, 0x618, 0xA00);
		...
		EV_CameraAng(0, 0, 0xFFE3, 0x9718, 0xFD00);
		...
		EV_CameraAng(0, 25, 0x9E3, 0xA518, 0xFD00);
		EV_ClrFace(player);
		if (VoiceLanguage == Languages_Japanese)
		{
