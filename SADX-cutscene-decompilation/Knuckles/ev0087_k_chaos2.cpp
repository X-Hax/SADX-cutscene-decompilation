...
void ev0087_k_chaos2(int state)
{
	...
	case 1:
		...
		EV_CameraAng(1, 80, 0xFD53, 0x861B, 0);
		EV_Wait(40);
		...
		EV_CameraAng(1, 0, 0x429, 0xEFF4, 0xFF00);
		EV_CameraPos(1, 20, 6.9000001f, 12.5f, -44.400002f);
		EV_CameraAng(1, 20, 0x453, 0xED1B, 0xFF00);
		EV_SetAng(eggman, 0, 0xF000, 0);
		EV_ClrAction(eggman);
		EV_SetAction(eggman, &action_g_g0029_eggman, &EGGMAN_TEXLIST, 0.1f, 1, 0);
		EV_SetPos(W_EME, 5.1999998f, 14.0f, -56.700001f);
		EV_SetAng(W_EME, 0x1000, 0xFB00, 0);
		stopObjectAll();
		EV_SetAng(player, 0, 0x7000, 0);
		EV_SerifPlay(1037);
		EV_Msg(msgTbl_ev0087[TextLanguage][2]); //"\aUhhh, this isn't \nwhat you're after!"
		moveObjectAngle2(W_EME, 5.1999998f, 14.0f, -56.700001f, 4.9000001f, 14.0f, -58.5f, 0x1000, 0, 0, -0x1000, 0, 0, 18);
		EV_Wait(18);
		EV_CameraPos(1, 60, 5.6999998f, 11.68f, -45.0f);
		EV_CameraAng(1, 60, 0xC20, 0xFFFD, 0);
		moveObjectAngle2(W_EME, 4.9000001f, 14.0f, -58.5f, 4.9000001f, 14.5f, -57.5f, 0x1000, 0, 0, -0x1000, 0, 0, 40);
		EV_Wait(45);
		moveObjectAngle2(W_EME, 4.9000001f, 14.5f, -57.5f, 6.5f, 14.3f, -55.700001f, -0x1000, 0, 0, 0x1000, 0, 0, 75);
		EV_Wait(25);
		EV_CameraPos(0, 55, 5.6999998f, 12.6f, -47.860001f);
		EV_Wait(60);
		EV_SetAction(eggman, &action_g_g0001_eggman, &EGGMAN_TEXLIST, 1.0f, 1, 0);
		EV_CameraPos(1, 0, -3.9000001f, 2.8f, -37.400002f);
		EV_CameraAng(1, 0, 0x953, 0x901B, 0);
		EV_CameraPos(1, 50, -2.4000001f, 3.8f, -33.799999f);
		EV_CameraAng(1, 50, 0x953, 0x901B, 0);
		...
		EV_CameraAng(0, 120, 0xC53, 0xD01B, 0xFB00);
		EV_SerifPlay(1039);
		...
		EV_CameraAng(1, 0, 0xF1, 0xAADA, 0xE6);
		EV_Wait(45);
		...
		EV_CameraAng(1, 0, 0xB6, 0xAB98, 0);
		EV_CameraPos(1, 80, -25.4f, 4.1199999f, -63.799999f);
		EV_CameraAng(1, 80, 0xB6, 0x9F98, 0);
		ToWaterChaos1();
		EV_Wait(10);
		crushLightOn(
			W_EME->twp->pos.x,
		...
		EV_CameraAng(1, 0, 65265, 6113, 0x100);
		EV_SetPos(eggman, 7.54f, 0.0f, -49.200001f);
		EV_SetAng(eggman, 0, 0xE000, 0);
		EV_CameraPos(1, 120, 12.2f, 1.5f, -25.700001f);
		EV_CameraAng(1, 120, 0xF08, 0x16DA, 0x100);
		EV_Wait(40);
		EV_SerifPlay(1046);
		...
		EV_CameraAng(1, 0, 0x3F1, 0xA7DA, 0);
		...
		EV_CameraAng(1, 0, 0x9F1, 0xF5DA, 0);
		...
		EV_CameraAng(1, 100, 0x9F1, 0xF8D8, 0);
