...
void ev0084_k_pastfirst(int state)
{
    ...
    case 1:
        ...
        EV_CameraAng(1, 0, 64512, 18176, 0);
        EV_CameraAng(1, 200, 64512, 43008, 0);
        EV_Wait(160);
        ...
        EV_CameraAng(1, 0, 64512, 61184, 0);
        EV_CameraPos(1, 100, -0.72799999f, 106.526f, -715.896f);
        EV_CameraAng(1, 100, 256, 61184, 0);
        EV_Wait(30);
        ...
        EV_CameraAng(1, 60, 2048, 0x8000, 0);
