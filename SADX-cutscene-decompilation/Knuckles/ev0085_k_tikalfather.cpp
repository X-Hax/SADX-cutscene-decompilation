...
void ev0085_k_tikalfather(int state)
{
	...
	case 1:
		...
		EV_Wait(1);
		EV_CameraPerspective(0, 120, 12743);
		EV_Wait(120);
		EV_SetFace(tikal, "FD");
		EV_SerifPlay(1024);
		...
		EV_CameraAng(1, 0, 3328, 15360, 0);
		EV_CameraAng(0, 160, 3328, 12288, 0);
		EV_SerifPlay(1025);
		...
		EV_CameraAng(1, 0, 1536, 768, 0);
		EV_SetAng(tikal, 0, 59392, 0);
		EV_CameraPos(0, 200, -22.631599f, 6.277f, 1210.2318f);
		EV_CameraAng(0, 200, 1024, 42752, 0);
		EV_SerifPlay(1028);
		...
		EV_CameraAng(1, 0, 145, 63856, 0);
		EV_CameraPos(1, 110, -4.1399999f, 7.6199999f, 1232.95f);
		EV_CameraAng(1, 110, 145, 64880, 0);
		EV_SerifPlay(1030);
		...
		EV_CameraAng(1, 0, 63488, 58624, 0);
		EV_SetFace(tikal, "EA");
		EV_SetFace(tikal, "FE");
		EV_SerifPlay(1031);
