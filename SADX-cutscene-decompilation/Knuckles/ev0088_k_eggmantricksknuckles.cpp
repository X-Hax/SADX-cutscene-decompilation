...
void ev0088_k_eggmantricksknuckles(int state)
{
	...
	case 1:
		...
		EV_CameraAng(1, 0, 0xC100, 0x900, 0);
		EV_CameraAng(1, 90, 0xFC00, 0x900, 0);
		EV_Wait(60);
		EventSe_Stop(0);
		EV_Wait(1);
		EV_SerifPlay(1050);
		...
		EV_CameraAng(1, 0, 0x500, 0x6500, 0);
		EV_Wait(20);
		EV_MsgCls();
		EV_Wait(1);
		EV_SerifWait();
		...
		EV_CameraAng(1, 0, 0xF700, 0x1E00, 0);
		EV_Wait(10);
		...
		EV_CameraAng(1, 80, 0x800, 0x2600, 0);
		EV_ClrFace(eggman);
		...
		EV_CameraAng(1, 0, 0x300, 0x4C00, 0);
		EV_CameraChase(player);
		EV_ClrAction(player);
		...
		EV_CameraAng(1, 0, 0, 0x4800, 0);
		EV_CameraPos(1, 400, -14.62f, 33.720001f, -8.7200003f);
		EV_CameraAng(1, 400, 0xF800, 0x8E00, 0);
		EV_ClrAction(player);
		EV_ClrFace(player);
