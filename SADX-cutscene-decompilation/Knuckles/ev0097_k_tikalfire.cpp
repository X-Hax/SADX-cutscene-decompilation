...
void ev0097_k_tikalfire(int state)
{
	...
	case 1:
		...
		EV_CameraAng(1, 0, 59392, 60672, 0);
		...
		EV_CameraAng(1, 0, 512, 37376, 512);
		EV_CameraPos(0, 50, -19.7556f, -2.6654999f, 428.55801f);
		EV_CameraAng(0, 50, 2304, 37376, 512);
		EV_SerifPlay(1137);
		...
		EV_CameraAng(1, 0, 2560, 49920, 512);
		EV_CameraPos(0, 190, -27.440001f, -2.55f, 441.57999f);
		EV_CameraAng(0, 190, 1024, 51712, 512);
		EV_Wait(5);
		EV_SerifPlay(1138);
		...
		EV_CameraAng(1, 0, 5888, 37120, 1024);
		EV_CameraAng(0, 170, 5888, 32512, 1024);
		EV_SetAng(tikal, 1264, 28672, 0);
		...
		EV_CameraAng(1, 10, 4608, 32512, 768);
		...
		EV_CameraAng(0, 0, 3056, 64972, 1280);
		EV_CameraPos(0, 40, -10.0f, 28.0f, 356.0f);
		EV_CameraAng(0, 40, 2800, 0, 768);
		EV_Wait(40);
		EV_CameraPos(0, 0, -5.0f, 55.0f, 267.0f);
		EV_CameraAng(0, 0, 2544, 0, 512);
		EV_CameraPos(0, 40, 0.0f, 85.0f, 167.0f);
		EV_CameraAng(0, 40, 2288, 0, 0);
		EV_Wait(50);
		...
		EV_CameraAng(0, 70, 1872, 30668, 0);
		EV_Wait(10);
